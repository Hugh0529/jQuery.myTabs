...
;(function ($) {
    $.myTabs = function (container, options) {
        ...
        //
        //    if ( $targetPanel.data('myTabs') && $targetPanel.data('myTabs').lastHeight ) {
        //        return $targetPanel.data('myTabs').lastHeight;
        //    }
        //
        //    // this is the only property myTabs changes, so we need to grab its value on each tab change
        ...
        //    $targetPanel.css({
        //        position: $targetPanel.data('myTabs').position,
        //        visibility: $targetPanel.data('myTabs').visibility,
        //        display: display
        //    });
        //
        //    // Cache height
        //    $targetPanel.data('myTabs').lastHeight = height;
        //
        //    return height;
        //};
        //
        ...
        //
        //    if( $visiblePanel.data('myTabs') ) {
        //        $visiblePanel.data('myTabs').lastHeight = height;
        //    } else {
        //        $visiblePanel.data('myTabs', {lastHeight: height});
        //    }
        //    return height;
